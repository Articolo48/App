 ...
 * {@link Siamo.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Siamo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Siamo extends Fragment {
     ...
     * @return A new instance of fragment Siamo.
     */
    // TODO: Rename and change types and number of parameters
    public static Siamo newInstance(String param1, String param2) {
        Siamo fragment = new Siamo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Siamo");
        View view = inflater.inflate(R.layout.fragment_siamo, container, false);
        ...
        final Fragment frag = new Siamo_Tema();
        ...
        donne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                args.putString("tema", "Siamo_Donne");
        ...
        lavoro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                args.putString("tema", "Siamo_Lavoro");
