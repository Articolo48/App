 ...
 * {@link Prog_Estero.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Prog_Estero#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Prog_Estero extends Fragment {
     ...
     * @return A new instance of fragment Prog_Estero.
     */
    // TODO: Rename and change types and number of parameters
    public static Prog_Estero newInstance(String param1, String param2) {
        Prog_Estero fragment = new Prog_Estero();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Estero");
        View view = inflater.inflate(R.layout.fragment_prog__estero, container, false);
        final ImageButton civiapopolare    = (ImageButton) view.findViewById(R.id.civica_popolare_lorenzin);
        ...
        civiapopolare.setOnClickListener(new View.OnClickListener() {
            @Override
