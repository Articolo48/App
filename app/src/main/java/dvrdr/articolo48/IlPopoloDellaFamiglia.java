 ...
 * {@link IlPopoloDellaFamiglia.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link IlPopoloDellaFamiglia#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IlPopoloDellaFamiglia extends Fragment {
     ...
     * @return A new instance of fragment IlPopoloDellaFamiglia.
     */
    // TODO: Rename and change types and number of parameters
    public static IlPopoloDellaFamiglia newInstance(String param1, String param2) {
        IlPopoloDellaFamiglia fragment = new IlPopoloDellaFamiglia();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_il_popolo_della_famiglia, container, false);
        ...
        final Fragment frag       = new IlPopoloDellaFamiglia_Tema();
        ...
        europa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                args.putString("tema", "IlPopoloDellaFamiglia_Europa");
        ...
        lavoro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                args.putString("tema", "IlPopoloDellaFamiglia_Lavoro");
